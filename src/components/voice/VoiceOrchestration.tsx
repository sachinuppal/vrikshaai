  ...
  return (
    <div className="relative h-[400px] flex items-center justify-center">
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 400 400" preserveAspectRatio="xMidYMid meet">
        ...
        {channels.map((_, index) => {
          const pos = getPosition(index, channels.length);
          const centerX = 200;
          const centerY = 200;
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        {channels.map((channel, index) => {
          ...
          return (
            ...
            >
              <motion.div
                className={`relative w-16 h-16 rounded-2xl flex items-center justify-center bg-gradient-to-br ${channel.color} shadow-lg`}
                animate={{
